    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="contact-form mt-5">
                ...
                @endif
                <form method="post" action="{{ route('sendOtpForContact') }}">
                    {{ csrf_field() }}


                    <div class="form-group">
                        <label for=""> Select Your Country Name : </label>
                        @php
                    ...
                    <p>For preventing spam message, please verify your phone number first.</p>
                    ...
                    <div class="form-group">
                        <input type="submit"  id="button1" disabled="disabled" class="btn btn-info custom-btn-info" value="Send OTP">
                    </div>
                </form>
            </div>
        </div>
