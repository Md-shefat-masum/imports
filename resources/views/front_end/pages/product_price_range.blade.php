	...
	<article class="single_product">
		...
		<figure>
			...
			<?php
				...
				?>
			<div class="product_thumb product_thumb_two" style="height: 263px; padding: 10px 0px 0px 10px;">
				...
				<div class="action_links">
					<ul>
						...
						<li class="quick_button"><a href="/porduct_details/{{$p->id}}" title="quick view"><i
