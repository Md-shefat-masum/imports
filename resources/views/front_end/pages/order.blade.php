                    ...
                    <table class="table table-hover">
                        ...
                        @foreach( $orders as $row )
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary view" data-target="#_{{ $row->id }}" data-toggle="modal" href="#"> View </a>

                                    <!-- Modal -->
                                    <div class="modal fade" id="_{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<style>
    ...
    .table2 td { padding: 3px 2px; text-align: left; }
    .table2 th { padding: 3px 1px; text-align: left; }
</style>
