			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Forums Category</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						...
						<div class="modal fade bd-example-modal-lg" id="bd-example-modal-lg">
							<form action="{{ route('category_store')}}" method="post" id="add_data"
								enctype="multipart/form-data">
								{{csrf_field()}}
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header modal-header-color">
											<h5 class="modal-title">Add Forums Category</h5>
										...
										<div class="modal-body text-left">
											...
											<div class="form-group">
                                                <label for="">Forums Category</label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm btn-color-ceate">
                                        ...
                                        <a href="{{route('b_category_edit',$data->id)}}" class="btn btn-info view-btn">Edit</a>
                                        <a class="btn btn-danger delete-btn">
                                            <form action="{{route('b_category_destroy',$data->id)}}" method="POST">
                                                @method('DELETE')
