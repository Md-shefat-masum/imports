		...
		<div class="col-md-12 ">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">discount Product
					...
					<div class="modal modal-success fade" id="modal-success">
						<div class="modal-dialog">
							<form action="{{route('discount_product.store')}}" method="POST" enctype="multipart/form-data">
								{{csrf_field()}}
											...
											<td>
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<li><a href="#">View</a></li>
														<li><a href="{{route('discount_product.edit',$sp->id)}}">Edit</a></li>
														<li><form action="{{url('/pages/discount_product',$sp->id)}}" method="POST">
															@method('DELETE')
															{{csrf_field()}}
															<button class="" style="
															background: none;
