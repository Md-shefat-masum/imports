			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Terms And Condition</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						...
						<div class="modal fade bd-example-modal-lg" id="bd-example-modal-lg">
							<form action="{{route('terms.store')}}" method="post" id="add_data" enctype="multipart/form-data">
								@csrf
									...
									<div class="modal-content">
										...
										<div class="modal-body text-left">
											...
											<div class="form-group">
												...
												<textarea name="description" id="my-editor" cols="30" rows="10" class="form-control"></textarea>
							...
							<td>
								<div class="btn-group btn-group-sm btn-color-ceate">
									...
									<a class="btn btn-danger delete-btn">
										<form action="{{url('pages/terms',$data->id)}}" method="POST">
											@method('DELETE')
