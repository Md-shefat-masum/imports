			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Privency And Policy</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="" class="btn" data-toggle="modal" data-target="#bd-example-modal-lg"><i
								class="fa fa-plus-circle"></i> Add
							Privency And Policy</a>

						<div class="modal fade bd-example-modal-lg" id="bd-example-modal-lg">
							<form action="{{route('policy.store')}}" method="post" id="add_data" enctype="multipart/form-data">
								@csrf
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header modal-header-color">
											<h5 class="modal-title">Privency And Policy</h5>
										...
										<div class="modal-body text-left">
											...
											<div class="form-group">
												<label for="">Description</label>
													<textarea name="description" id="my-editor" cols="30" rows="10" class="form-control summernote"></textarea>
						...
						<td>{{date('M j,Y h:ia',strtotime($data->create_at))}}</td>
							...
							<td>
								<div class="btn-group btn-group-sm btn-color-ceate">
									...
									<a href="{{route('policy.edit',$data->id)}}" class="btn btn-info view-btn">Edit</a>
									<a class="btn btn-danger delete-btn">
										<form action="{{url('pages/policy',$data->id)}}" method="POST">
											@method('DELETE')
