...
@section('title','|Entrepreneur Sales')
@section('stylesheet')
            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> Entrepreneur Sales Reports</h3>
                    </div>
                        ...
                        @if($row->status == 3 )
                            <tr>
                                ...
                                <td>$
                                    ...
                                    $pp = $row->order_total;
                                    $total = $sp+$pp;
                                    $amount = number_format($row->order_total,2);
                                    $rate = 3/100;
                                    $comi = ($rate * $row->order_total);
                                    @endphp
                                    {{ $comi }}
                                </td>
                                ...
                                <td>
                                    ...
                                    @if($row->status==0 &&($group_id==1 || $group_id==2))
                                        <a class="btn btn-default" href="{!! url('pages/orders?action=process&id='.$orderId ) !!}" onclick="return confirm('Are you sure you want to accept?')" > Processing </a>
                                    @elseif($row->status==1 &&($group_id==1 || $group_id==3))
                                        <a class="btn btn-default" href="{!! url('pages/orders?action=deliver&id='.$orderId ) !!}" onclick="return confirm('Are you sure you want to cancel?')" > Deliver </a>
                                    @endif
                                    <a class="btn btn-default view"href="#"> Sales </a>
