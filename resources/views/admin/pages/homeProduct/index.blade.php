	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Home product list</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="{{ route('addHome') }}" class="btn"><i class="fa fa-plus-circle"></i> Add Home Product</a>
			...
			<tr>
			  ...
			  <td>
				<form method="POST" action="{{ route('homeDelete', $slider->id) }}" accept-charset="UTF-8" style="display:inline">
					 {{ method_field('DELETE') }}
					 {{ csrf_field() }}
