...
@section('title','|blogpopup Offer Product')
@section('stylesheet')
<style media="screen">
			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Falsh Sale Product</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="{{ route('blogpopupProduct') }}" class="btn"><i class="fa fa-reply"
								aria-hidden="true"></i>
							Back</a>
				...
				<table cellspacing="0" bordercolor="gray" id="allTable"
					...
					<tbody>
						...
						<td style="display: block ruby;">
							<form class="form-inline" action="{{ route('addToblogpopup') }}" method="post">
								@csrf
								...
								<button type="submit" class="btn btn-primary">Make Popup</button>
							</form>
						</td>
						</tr>
