            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> Shipping List</h3>
                    </div>
                            ...
                            for($i=1; $i<=5-strlen($orderId); $i++) $pre .="0" ; @endphp <td>{{ $row->id+1000 }}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default"
                                        ...
                                        onclick="return confirm('Are you sure this is delivered?')"> Deliver </a>
                                    @endif

                                    <a class="btn btn-default view" data-target="#rowid{{ $row->id }}" data-toggle="modal"
                                        href="#"> View </a>
