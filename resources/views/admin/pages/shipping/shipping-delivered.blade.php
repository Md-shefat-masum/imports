            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> Delivery List</h3>
                    </div>
                        ...
                        <tr>
                            ...
                            for($i=1; $i<=5-strlen($orderId); $i++) $pre .="0" ; @endphp <td>{{ $row->id+1000 }}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default view" data-target="#{{ $row->id }}" data-toggle="modal"
                                        href="#"> View </a>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <table class="table table-bordered">
                                                                                <tr>
                                                                                    <th style="border: 0;">Billing Name
                                                                                    </th>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="border: 0;">Billing City
                                                                                    </th>
                                                                                    <td style="border: 0;">:</td>
                                                                                    <td style="border: 0;">
                                                                                        {{ $user->city }}</td>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="border: 0;">Billing State
                                                                                    </th>
                                                                                    <td style="border: 0;">:</td>
                                                                                    <td style="border: 0;">
                                                                                        {{ $user->states }}</td>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="border: 0;">Phone Number
                                                                                    </th>
                                                                                    <td style="border: 0;">:</td>
                                                                                    <td style="border: 0;">
                                                                                        {{ $user->cell_phone }}</td>
