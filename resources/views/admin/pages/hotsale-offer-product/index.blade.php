			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Hotsale Offer Product</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="{{ route('addhotsale') }}" class="btn"><i class="fa fa-plus-circle"></i> Add
							Hotsale Offer Product</a>
				...
				<table cellspacing="0" bordercolor="gray" id="allTable"
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<form class="form-inline" action="{{ route('edithotsale') }}" method="post"
									...
									<div class="form-group">
										<select class="form-control" id="sel1" name="status" required>
											<option value="1"
												{{ ($discount->hotsale_position == 1)? 'selected' : '' }}>Active
											</option>
											<option value="0"
												{{ ($discount->hotsale_position == 0)? 'selected' : '' }}>
												Inactive</option>
										</select>
									</div>
							...
							<td>
								<form method="POST" action="{{ route('hotsaleDelete', $discount->id) }}"
