            ...
            <div class="card-header header-part">
                <div class="row">
                    <div class="col-md-6 card_header_title">
                        <h3><i class="fa fa-gg-circle"></i> All Supplier</h3>
                    </div>
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="suppliers_item" id="my-editor" cols="30" rows="5" class="form-control"></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm btn-color-ceate">
                                    ...
                                    <a href="{{route('supplier-forum.edit',$data->id)}}"
                                        class="btn btn-info view-btn">Edit</a>
                                    <a class="btn btn-danger delete-btn">
                                        <form action="{{url('pages/supplier-forum',$data->id)}}" method="POST">
                                            @method('DELETE')
