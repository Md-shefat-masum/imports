		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="modal modal-success fade" id="modal-success">
					<form action="{{route('services.store')}}" method="post" id="add_data">
				  @csrf
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">How It Work Stem</h4>
								</div>
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<textarea name="step_description"  cols="30" rows="10" class="form-control" required></textarea>
									</div>
						...
						<td>
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="{{route('services.edit',$data->id)}}">Edit</a></li>
									<li><form action="{{url('pages/services',$data->id)}}" method="POST">
										@method('DELETE')
										{{csrf_field()}}
										 <button class="" style="
										    background: none;
