            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-part">
                        <div class="row">
                            <div class="col-md-6 card_header_title">
                                <h3><i class="fa fa-gg-circle"></i> Orders List</h3>
                            </div>
                    ...
                    <div class="card-body table-responsive">
                        <table cellspacing="0" bordercolor="gray" id="allTable"
                            ...
                            @foreach($orders as $row )
                                ...
                                @php
                                    $disrate=
                                    DB::table('all_bids')->where('user_id',$row->user_id)->first();
                                    // dd($orders);
                                @endphp
                                        ...
                                        @if($row->status == 0 )
                                            ...
                                            <tr>
                                                @php
                                                    $orderId = $row->id;
                                                    $pre = "";
                                                    for($i=1; $i<=5-strlen($orderId); $i++) $pre .="0" ; @endphp
                                                <td>{{ $row->id+1000 }}</td>
                                                <td>{{ $row->first_name." ".$row->last_name }}</td>
                                                <td>{{ $row->payment_type }}

                                                    @if ($row->payment_type == 'epaymaker')
                                                        @if ($row->payment_status == 'paid')
                                                            <span style="font-size: 10px !important;color: red;font-weight: bold;background: yellow;padding: 1px 5px;border-radius: 5px;">Paid</span>
                                                        @else
                                                            <span style="font-size: 10px !important;color: red;font-weight: bold;background: yellow;padding: 1px 5px;border-radius: 5px;">UnPaid</span>
                                                        @endif
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @if($row->status==0 &&($group_id==1 || $group_id==3))
                                                        <a class="btn btn-info"
                                                           href="{!! url('pages/orders?action=process&id='.$row->user_id.'&order_id='.$row->id ) !!}"
                                                           onclick="return confirm('Are you sure this is delivered?')">
                                                            Processing </a>
                                                    @endif

                                                    <a class="btn btn-success" data-target="#rowid{{ $row->id }}" data-toggle="modal"
                                                       href="#">
                                                        View </a>


                                                    <!-- Modal -->
                                                    <div class="modal fade" id="rowid{{ $row->id }}" tabindex="-1" role="dialog"
                                                                                    ...
                                                                                    <div class="table-responsive">
                                                                                        <table class="table table-bordered">
                                                                                            ...
                                                                                            @foreach($details as $detail)
                                                                                                ...
                                                                                                @php
                                                                                                    $discoutrate=
                                                                                                    DB::table('all_bids')->where('product_id',$detail->product_id)->first();
                                                                                                @endphp
                                                                                                <tr>
                                                                                                    <td>{{ $detail->order_id+1000 }}</td>
                                                                                                    <td>{{ $detail->product_id }}</td>
                                                                                                    <td>{{ $detail->p_name }}</td>
                                                                                                    @if (!empty($discoutrate->discount_rate))


                                                                                                        <td>{{ $discoutrate->discount_rate ?? Null}}
                                                                                                            %
                                                                                                        </td>
                                                                                                    @else
                                                                                                        <td>0 %</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success" data-target="#rowid{{ $row->id }}" data-toggle="modal"
                                                   href="#">
                                                    View </a>
                                                <a class="btn btn-danger" data-target="#del{{ $row->id.$row->user_id }}"
                                                ...
                                                @if(Auth::user()->email == 'hsblco_admin@gmail.com')
                                                    ...
                                                    @if(!isset($order_log))
                                                        <form action="{{ route('create_order_log', $row->id)}}" method="post"
                                                              style="display: inline-block;">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit" class="btn btn-default view"
                                                                    href="{{ route('create_order_log', $row->id)}}">
                                                                Create Logs
                                                            </button>
                                                        </form>
                                                @endif
                    ...
                    // dd($discoutrate);
                                                                        ...
                                                                        <div class="pull-right"
                                                                             style="float:right; margin-top:50px; border-top:5px solid #ccc;">
                                                                            <table class="table">
                                                                                <tr>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-info print_cz"
                                                                        data-attr="{{$row->id}}">
                                                                    Print
                                                                </button>
                                                    ...
                                                    <div id="print-section" style="position:fixed; bottom:101%;">
                                                        <div class="modal-content" id="printTable{{$row->id}}"
                                                             style="width: 800px;">
                                                            <div class="modal-header">
                                                                <div
                                                                    style="text-align:center; width:100%; clear:both; margin-bottom:0px;">
                                                                    <img style="max-width:200px;"
                                                                         src="{{ asset('/front_end/img/logo.png') }}" alt="logo">
                                                                </div>
                                                                <h2 class="modal-title text-center" id="exampleModalLongTitle"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="panel panel-default">
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <table class="table table-bordered cz"
                                                                                       style="margin-top:50px; border-top:5px solid #ccc; text-align:left;">
                                                                                    <tr>
                                                                                        <th>Order ID</th>
                                                                                        <th>Product ID</th>
                                                                                        <th>Product Name</th>
                                                                                ...
                                                                                <div class="pull-right"
                                                                                     style="float:right; margin-top:50px; border-top:5px solid #ccc; text-align:left;">
                                                                                    <table class="table">
                                                                                        <tr>
                                                                                            <th style="border: 0;">
                                                                                                Total Bidding Amount
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="del{{ $row->id.$row->user_id }}" tabindex="-1"
                                                     role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content" id="" style="width: 800px;">
                                                            <div class="modal-header"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <a href="{{route('delete_order',$row->id)}}"
