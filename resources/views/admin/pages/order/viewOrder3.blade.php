                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($row->status==0 &&($group_id==1 || $group_id==3))
                                                <a class="btn btn-success" href="{!! url('pages/orders?action=process&id='.$row->user_id.'&order_id='.$row->id ) !!}" onclick="return confirm('Are you sure this is delivered?')">
                                                    Processing </a>
                                            @endif

                                            <a class="btn btn-info view" data-target="#{{ $row->id }}" data-toggle="modal" href="#">
                                                View </a>
                            ...
                            @if($row->status == 0 )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info view" data-target="#{{ $row->id }}" data-toggle="modal" href="#">
                                            View </a>
                                        <a class="btn btn-danger view" data-target="#{{ $row->id.$row->user_id }}" data-toggle="modal" href="#">
                                            Delete </a>
