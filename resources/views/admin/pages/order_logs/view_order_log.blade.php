                                        ...
                                        @if($row->status == 0 )
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-default view" data-target="#{{ $row->id.$row->user_id }}" data-toggle="modal" href="#">Delete </a>

                                                    <a class="btn btn-default view" href="{{ route('edit_order_log', $row->id) }}">Edit </a>
                                                ...
                                                <!-- Modal -->
                                                                            ...
                                                                            <div class="panel panel-default">
                                                                                <div class="panel-body">
                                                                                    @php
                                                                                        ...
                                                                                        $billing = DB::table('order_log_billing_address')->where('order_log_id', $row->id)->first();

                                                                                        $details = DB::table('order_log_details')
                                                                                        ->join('products','order_log_details.product_id','=','products.id')
                                                                                        ->select('order_log_details.*','products.*')
                                                                                        ->where('order_id',$orderId)
                                                                                        ->get();

                                                                                        $shipping = DB::table('order_log_shipping_address')->where('order_log_id', $row->id)->first();
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            ...
                                                                                            <table class="table table-bordered">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->name }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Email
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->email }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Billing Address
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->address }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Billing City
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->city }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Billing State
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->state }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Zip Code
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->zip_code }}</td>
                                                                                                </tr>
                                                                                                <!-- <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Phone Number
                                                                                                    ...
                                                                                                    <td style="border: 0;">{{ $billing->phone_number }}</td>
                                                                                                </tr> -->
                                                                                            ...
                                                                                            <table class="table table-bordered">
                                                                                                @if ($shipping)
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="border: 0;">{{ $shipping->name }}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th style="border: 0;">
                                                                                                            Shipping
                                                                                                        ...
                                                                                                        <td style="border: 0;">{{ $shipping->email }}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th style="border: 0;">
                                                                                                            Shipping
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="border: 0;">{{ $shipping->state }}</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th style="border: 0;">
                                                                                                            Zip Code
                                                                                                    ...
                                                                                                    <!-- <tr>
                                                                                                        ...
                                                                                                        <td style="border: 0;">{{ $shipping->phone_number }}</td>
                                                                                                    </tr> -->
                                                                                                @endif
                                                                                            </table>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-md-6" style="float:left">
                                                                                            ...
                                                                                            <table class="table table-bordered" style="text-align:left;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="border: 0;width: 150px;">{{ $billing->address }}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th style="border: 0;">
                                                                                                        Billing City
                                                    ...
                                                    <div class="modal fade" id="{{ $row->id.$row->user_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content" id="" style="width: 800px;">
                                                                <div class="modal-header">
                                                                    <h2 class="modal-title text-center" id="exampleModalLongTitle">Order Log Delete</h2>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <h3>Do you want to delete order log !!</h3>
                                                                        </div>
                                                                    </div>

                                                                    <div class="modal-footer">
                                                                        <a href="{{route('delete_order_log',$row->id)}}" class="btn btn-danger">Delete</a>
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">
                                                                            Close
                                                                        </button>
                                                                    </div>
