			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All Bigsales</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						...
						<div class="modal fade bd-example-modal-lg" id="bd-example-modal-lg">
							<form action="{{route('big_sales_store')}}" method="post" id="add_data" enctype="multipart/form-data">
								@csrf
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header modal-header-color">
											<h5 class="modal-title">Bigsales</h5>
										...
										<div class="modal-body text-left">
											...
											<div class="form-group">
												<label for="">BigSale</label>
												<input type="text" name="title" class="form-control" id="brand" required>
											</div>
						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-sm btn-color-ceate">
									...
									<a href="{{route('big_sales_edit',$data->id)}}"
										class="btn btn-info view-btn">Edit</a>
									    <a class="btn btn-danger delete-btn">
                                            <form action="{{route('big_sales_destroy',$data->id)}}" method="POST">
                                                @method('DELETE')
