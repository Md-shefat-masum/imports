			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> Home Product Category</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="{{ route('addHomecat') }}" class="btn"><i class="fa fa-plus-circle"></i> Add
					...
					<tbody>
						...
						<tr>
							...
							<td style="display: block ruby;">
								<form class="form-inline" action="{{ route('editHomecat') }}" method="post"
								...
								<form method="POST" action="{{ route('homecatDelete', $slider->id) }}"
