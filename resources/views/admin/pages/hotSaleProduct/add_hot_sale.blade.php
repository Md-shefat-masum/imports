			...
			<div class="card-header header-part">
				<div class="row">
					<div class="col-md-6 card_header_title">
						<h3><i class="fa fa-gg-circle"></i> All HotSale List</h3>
					</div>
					<div class="col-md-6 text-right card_header_btn">
						<a href="{{ route('hot_sale_product') }}" class="btn"><i class="fa fa-reply"
								aria-hidden="true"></i>
							Back</a>
			...
			<div id="printableTable" class="card-body table-responsive">
				<table cellspacing="0" bordercolor="gray" id="allTable"
					...
					<tbody>
						...
						@php
						$sliderPro = DB::table('hot_sale_products')->where('pro_id', $sp->id)->get();
						@endphp
						@if (count($sliderPro)<1) <?php $i++; ?> <tr>
							...
							<td style="display: block ruby;">
								<form class="form-inline" action="{{ route('addToHotSale') }}" method="post">
									...
									<button type="submit" class="btn btn-primary">Make Hot Sale</button>
								</form>
							</td>
							</tr>
