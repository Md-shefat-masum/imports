...
<div class="row">
	...
	<div class="col-md-12">
		...
		<form action="{{route('aboutOne.update',$aboutOne->id)}}" method="post" enctype="multipart/form-data">
			{{csrf_field()}}
			@method('PUT')
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row custom_form">
						...
						<div class="col-sm-8">
							<textarea name="description" id="my-editor" cols="30" rows="10"
								class="form-control">{{$aboutOne->description}}</textarea>
					...
					<div class="form-group row custom_form">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="btn_name" value="{{$aboutOne->btn_name}}">
						</div>
					</div>
					<div class="form-group row custom_form">
						<label class="col-sm-3 col-form-label">Button Link</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="btn_link" value="{{$aboutOne->btn_link}}">
						</div>
					</div>
					<div class="form-group row custom_form">
					...
					<div class="form-group row custom_form">
						...
						<div class="col-sm-8">
							<select name="status" id="status" class="form-control">
								<option value="{{$aboutOne->status}}">
									@if($aboutOne->status==0)
									{{"Unpulish"}}
									@else
									{{"Publish"}}
									@endif
